...
| [sr_ru_usa_geo.conf](https://raw.githubusercontent.com/misha-tgshv/shadowrocket-configuration-file/refs/heads/main/conf/sr_ru_usa_geo.conf)  | Вариант `sr_ru_geo.conf`, где Gemini, Google AI Studio и NotebookLM принудительно идут через группу `VPN-USA` с серверами `vpn-usa`. |
